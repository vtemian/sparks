# Why sparks is shaped like this

Decisions, measurements and maintenance traps, for anyone changing the code. If you only
need to install sparks or run a job with it, INSTALL_CLAUDE.md is the whole answer and
this file is not required reading.

Everything here was expensive to learn. A claim with a number in it came from an
experiment; a "do not" came from something that broke.
